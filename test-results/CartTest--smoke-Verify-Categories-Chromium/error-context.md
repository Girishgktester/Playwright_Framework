...
- Name: @smoke Verify Categories
- Location: C:\Users\user\Playwright_Framework\tests\CartTest.spec.js:3:1

# Error details

```
Error: Singup/ login button displayed in hompage
...
Call log:
  - Singup/ login button displayed in hompage with timeout 40000ms
  - waiting for getByText(' Signup / Login').first()
    ...
    at Placeorder.loginToApplication (C:\Users\user\Playwright_Framework\pages\Placeorder.js:35:30)
    at C:\Users\user\Playwright_Framework\tests\CartTest.spec.js:5:22
```
